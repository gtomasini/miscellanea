...
vector<int> numberOfItems(string s, vector<int> startIndices, vector<int> endIndices) {
    ...
    cout<<"size: "<<startIndices.size()<<endl;
    for (size_t i=0; i < startIndices.size(); i++){
        const int startIdx=startIndices[i];
        const int endIdx=endIndices[i];
        
        string sub_str=s.substr(startIdx-1, endIdx-startIdx+1);
        cout<<i<<", sub_str: "<<sub_str<<endl;
        
        unsigned long items=0, total=0;
        bool start=false;
        for (int j=0; j<sub_str.length(); j++){
            //cout<<sub_str[j]<<": ";
            const char c=sub_str[j];
            //const char c=str[j+startIdx-1];
...
int main()
{
    ...
    s="*|*|";
    vector<int> startIdxs1={1, 1};
    vector<int> endIdxs1  ={1, 4};

    out=numberOfItems(s, startIdxs1, endIdxs1);
    ...
    s="*|*|*|";
    vector<int> startIdxs2={1, 1};
    vector<int> endIdxs2  ={1, 6};

    out=numberOfItems(s, startIdxs2, endIdxs2);
